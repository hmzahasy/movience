      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Obx(
              (() => Get.find<SearchCont>().isLoading.value
                  ? const CircularProgressIndicator()
                  : Get.find<SearchCont>().foundedMovies.isEmpty
                      ? SizedBox(
                          width: Get.width / 1.5,
                          child: Column(
                            children: [
                              ...
                              const Text(
                                'Sorry, We Can Not Find The Movie',
                      ...
                      : ListView.separated(
                          itemCount:
                              Get.find<SearchCont>().foundedMovies.length,
                          shrinkWrap: true,
                          ...
                          itemBuilder: (_, index) {
                            Movie movie =
                                Get.find<SearchCont>().foundedMovies[index];
